...
public class CusTravelPicJDBCDAO implements CusTravelPicDAO_interface {
	...
	private static final String INSERT_STMT =
			"INSERT INTO CUS_TRAVEL_PIC (CUS_TRAVEL_PIC_ID, CUS_TRAVEL_DETAIL_ID, PIC_NAME, PIC_FILETYPE, DATE_RECORD, PIC) VALUES ('CTP'||LPAD(CUS_TRAVEL_PIC_ID_SEQ.NEXTVAL,6,'0'), ?, ?, ?, ?, ?)";
	...
	public static void main(String[] args) {
		...
		CusTravelPicJDBCDAO dao = new CusTravelPicJDBCDAO();
		File pic = new File("WebContent/pictures/漂亮嗎.jpg");
		File pic2 = new File("WebContent/pictures/2835-2.gif");
		InputStream in;
		
//		//新增
		CusTravelPicVO cusTravelPicVO1 = new CusTravelPicVO();
		cusTravelPicVO1.setCusTravelDetailId("CTD000001");
		cusTravelPicVO1.setPicName("漂亮嗎?11");
...
//		
//		//查詢 by pk
		CusTravelPicVO cusTravelPicVO3 = dao.findByPrimaryKey("CTP000001");
