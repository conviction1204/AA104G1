...
public class Test_DataSource extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/TestDBG1");
			if (ds != null) {
				...
				if (conn != null) {
					...
					ResultSet rs = stmt.executeQuery("select * from CUS_TRAVEL_DETAIL");
					while (rs.next()) {
						out.println("CusTravelDetailId = " + rs.getString(1));
					}
					conn.close();
				}
			}
